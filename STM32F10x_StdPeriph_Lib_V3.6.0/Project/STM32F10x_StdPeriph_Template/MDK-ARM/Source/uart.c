...
{	
	...
	USART1_SendChar(0xFF);
	USART1_SendChar(data_1/256);
	USART1_SendChar(data_1%256);
	USART1_SendChar(data_2/256);
	USART1_SendChar(data_2%256);
	USART1_SendChar(data_3/256);
	USART1_SendChar(data_3%256);
	USART1_SendChar(0);
	USART1_SendChar(0);
...
{	
	...
	USART2_SendChar(0xFF);
	USART2_SendChar(data_1/256);
	USART2_SendChar(data_1%256);
	USART2_SendChar(data_2/256);
	USART2_SendChar(data_2%256);
	USART2_SendChar(data_3/256);
	USART2_SendChar(data_3%256);
	USART2_SendChar(0);
	USART2_SendChar(0);
...
{	
	...
	USART3_SendChar(0xFF);
	USART3_SendChar(data_1/256);
	USART3_SendChar(data_1%256);
	USART3_SendChar(data_2/256);
	USART3_SendChar(data_2%256);
	USART3_SendChar(data_3/256);
	USART3_SendChar(data_3%256);
	USART3_SendChar(0);
	USART3_SendChar(0);
